        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 text-center">
                    <a href="FormRegistrarEstudiante.php" class="btn btn-primary btn-lg">Registrar Estudiante</a>
                </div>
                <div class="col-lg-6 text-center">
                    <a href="FormRegistrarMateria.php" class="btn btn-primary btn-lg">Registrar Materia</a>
                </div>
            </div>
